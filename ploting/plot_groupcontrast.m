...
sourcedir = '/project/3011044.02/analysis/freqanalysis/contrast/group/regressed';
...
% figure(1)
% subplot(3,1,1); plot(stat.freq, stat.stat); ylabel('t-value');
% subplot(3,1,2); semilogy(stat.freq, stat.prob); ylabel('prob');
% subplot(3,1,3); plot(stat.freq, stat.mask); ylabel('significant');
