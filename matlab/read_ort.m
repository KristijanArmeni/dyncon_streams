function [data] = read_ort(filename)

% READ_ORT reads *.ort files containing timing information for the
% individual sentence fragments in the file
%
% Input argument:
%   filename to the *.ort file
%
% Output argument:
