...
if ~isempty(resamplefs)
  ...
  cfg.method   = 'nearest';
  featuredata = ft_resampledata(cfg, ft_selectdata(audio, 'channel', audio.label(14:end)));
...
cfg.channelcmb = [audio.label repmat({'MEG'},numel(audio.label),1)];%{'UADC003' 'MEG'; 'audio_avg' 'MEG'};
