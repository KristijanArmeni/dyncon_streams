...
% Michal's code below seems to create some strange features in the
% feature_value_vector, e.g. sharp rising edges and single sample spikes.
% Also, it does not account for '.' as words.
