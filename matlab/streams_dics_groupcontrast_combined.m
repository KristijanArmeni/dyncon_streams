function streams_dics_groupcontrast_combined(opt)
% streams_dics_groupcontrast_combined(opt) performs group level analysis of 
% the output of streams_disc.m, but across frequency bands rather than 
% treating them as independent freq bands.
%
%
