...
load /project/3011044.02/preproc/atlas/cortex_inflated_shifted.mat
m.tri = ctx.tri;
m.pos = ctx.pos;
...
figure13 = fullfile(savedir, [suffix '-R']);
...
figure14 = fullfile(savedir, [suffix '-L']);
...
figure15 = fullfile(savedir, 'ba42R');
...
figure16 = fullfile(savedir, 'ba42L');
